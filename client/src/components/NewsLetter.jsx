  ...
  return (
    <div className='flex flex-col items-center justify-center text-center space-y-2 my-32'>
      ...
      <form className='flex items-center justify-between max-w-2xl w-full md:h-13 h-12'>
        ...
        <button type='submit' className='md:mx-12 px-8 h-full text-white bg-primary/80 hover:bg-primary transition-all cursor-pointer rounded-md rounded-l-none'>Subscribe</button>
      </form>
    </div>
  )
}
